...
function data_send(){
  ...
  var dataString = '&link_title1='+ link_title + '&link_url1='+ link_url;
  //alert(dataString);
  ...
  else
  {
    ...
    $.ajax({
      type: "POST",
      url: "controller/helpful_links_create_controller.php",
	  ...
	  $.ajax({    //create an ajax request to load_page.php
			...
			success: function(results){											
				// alert (results['batch_reward']);
				 $('#txt_link_url').val(results['link_url']);
         $('#txt_link_title').val(results['link_title']);		
...
function data_update(){
  ...
  var link_url     = $("#txt_link_url").val();
	...
	// Returns successful data submission message when the entered information is stored in database.
	var dataString = '&link_title1='+ link_title + '&link_url1='+ link_url + '&update_id1='+ id;
	//alert(dataString);
  if(link_title==''){ $("#txt_link_title_red").css("color","#EE5269" );}else{ $("#txt_link_title_red").css("color","green" );}
  if(link_url==''){$("#txt_link_url_red").css("color","#EE5269" ); }else{$("#txt_link_url_red").css("color","green" ); }
  if(link_title==''|| link_url==''){
...
<div class="container-fluid page_path_div" style=" background-color:#fff; height:auto; width:98%;color:#666666;">
  <div class="page_path" style="float:left;">Admin / Links Create</div>
  <div class="pagename" style="float:right;">Page: Links create</div><hr/>
    ...
    <div id="mySidenav" class="sidenav">
      ...
      <li><a class="menu active" href="helpful_links_create.php">Links Create</a></li>
...
-->
  ...
  <div class="col-md-6">
      <h2>links create / update form</h2>
      <p>you can create / update links by using this form</p>
  <form class="form-horizontal">
    <div class="form-group">
      <label class="control-label col-sm-4" for="linktitle">Links Title:</label>
      <div class="col-sm-8">
       <div class="input-group">
        <input type="text" class="form-control" id="txt_link_title" name="txt_link_title" placeholder="Enter link title name">
