...
if($login_session_usertype==1){$disabled_cond="";}else { $disabled_cond="disabled";}
if($login_session_usertype==1){$display_none_cond="";}else { $display_none_cond='style="display:none;"';}
...
function data_send(){
  ...
  var dataString = '&name1='+ username + '&email1='+ useremail + '&password1='+ userpassword + '&usertype1='+ usertype + '&status1='+ status + '&cbo_batch_name1='+ cbo_batch_name;
  //alert(dataString);
 ...
 if(usertype!=1 && cbo_batch_name==0){$("#batch_name_red").css("color","#EE5269" );}else{$("#batch_name_red").css("color","green" );}
  if(username==''||userpassword==''||againpass==''||useremail=='' ||usertype=='' || status=='' || (usertype!=1 && cbo_batch_name==0)){
  ...
  else
  {
    ...
    $.ajax({
      ...
      { 
        ...
        $("#cbo_batch_name").attr("disabled", true);
...
//alert('sdf');
    $.ajax({    //create an ajax request to load_page.php
      ...
      success: function(results){                     
         ...
         fnc_active_batch(results['user_type'],"<?php echo $login_session_usertype; ?>");
      }
  });
    //});
 //});
...
function data_update(){
  ...
  // Returns successful data submission message when the entered information is stored in database.
  var dataString = '&name1='+ username + '&email1='+ useremail + '&password1='+ userpassword + '&usertype1='+ usertype + '&status1='+ status  + '&cbo_batch_name1='+ cbo_batch_name + '&update_id1='+ id;
   if( $("#txt_userpassword").val()!= $("#txt_againuserpasswor").val() )
  {
     $("#msg_failed").css({"display":"block","background-color":"#EE5269"}).fadeOut(8000).text('Password not matched');
    return;
...
function fnc_active_batch(userType,login_session_usertype)
{
  if (userType==2 || userType==3) 
  {
     //$('#cbo_batch_name').attr('disabled',false);
...
-->
  ...
  <form class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
      <div class="input-group">
        <select style="margin-left:8px;" class="form-control" id="cbo_user_type" name="cbo_user_type" <?php echo $disabled_cond; ?> onchange="fnc_active_batch(this.value,<?php echo($login_session_usertype); ?>)";>
            <?php
    ...
    <div class="form-group">
      ...
      <div class="col-sm-8">
      <div class="input-group">
        <select style="margin-left:8px;" class="form-control" id="cbo_batch_name" name="cbo_batch_name" disabled <?php echo $disabled_cond; ?>>
   ...
   <div class="form-group">
      ...
      <div class="col-sm-8">
      <div class="input-group">  
        <select style="margin-left:8px;" class="form-control" id="cbo_user_status" name="cbo_user_status" <?php echo $disabled_cond; ?> >
      <?php
  ...
  <input type="hidden" id="update_id" name="update_id">
    <div class="form-group">
      ...
      <div class="col-sm-6">
         <div class="input-group">
            <button type="button" class="btn btn-primary" id="save" onClick="data_send();" <?php echo $display_none_cond; ?> >Create</button>
