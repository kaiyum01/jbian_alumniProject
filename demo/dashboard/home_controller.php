...
if(isset($_GET['action'])){
	...
	if($action_view_data=="list_view")
	{
		...
		?>
		<table class="table table-hover scroll" style="text-align: left;">
		<thead style="font-size: 12px; text-align: left;">
	...
	?>
      <tr style="cursor: pointer;">
		...
		<td style="font-size: 11px;"><?php echo $data[1]; ?></td>
		<td style="font-size: 11px;"><?php echo change_date_format($data[2],"dd-mm-yyyy","-",''); ?></td>
		<td style="font-size: 11px;"><?php echo $return_lib_company_arr[$data[3]]; ?></td>
		<td style="font-size: 11px;"><?php echo $return_lib_task_arr[$data[4]]; ?></td>
		<td style="font-size: 11px;"><?php echo get_extra_code($data[5]); ?></td>
		<td style="font-size: 11px;"><?php echo change_date_format($data[6],"dd-mm-yyyy","-",''); ?></td>		
		<td style="font-size: 11px;"><?php echo $data[7]; ?></td>
		<td style="font-size: 11px;"><?php echo $production_status[$data[8]]; ?></td>
		<td style="font-size: 11px;"><?php echo change_date_format($data[9],"dd-mm-yyyy","-",''); ?></td>
		<td style="font-size: 11px;"><?php echo $data[10]; ?></td>		
		<td style="font-size: 11px;"><?php echo $data[11]; ?></td>
		<td style="font-size: 11px;"><?php echo $bill_status[$data[12]]; ?></td>
      <!--  <td style="font-size: 11px;"><span class="glyphicon glyphicon-edit" onclick="get_data_from_list(<?php //echo $data[0]; ?>)";></span> | <span class="glyphicon glyphicon-trash" onclick="fnc_delete(<?php //echo $data[0]; ?>)";></span></td> -->
      </tr>
   <?php
  	}
  	?>
