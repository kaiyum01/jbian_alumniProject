...
$.ajax({
url: "controller/batch_wise_photo_controller.php", // Url to which the request is send
...
function show_datas(){
  // $(document).ready(function() {
    ...
    //alert('sdf');
      ...
      type: "GET",
      url: "controller/batch_wise_photo_controller.php",
...
//alert('sdf');
    $.ajax({    //create an ajax request to load_page.php
      ...
      success: function(results){                     
        ...
        var img_path=results['batch_photo_link'];

        var update_pic=results['batch_photo_link']; 
...
<div class="container-fluid page_path_div" style=" background-color:#fff; height:auto; width:98%;color:#666666;">
  <div class="page_path" style="float:left;">Admin / Batch Photos</div>
  <div class="pagename" style="float:right;">Page: Batch Photos</div><hr/>
...
<?php
if($login_session_usertype!=1 && in_array($login_session_batch, $total_year))
{
  $total_year=$newYearArr = array($login_session_batch);
}
else
{
  $total_year;
...
?>
  ...
  <div class="col-md-6">
      <h2>batch photos / update form</h2>
      <p>you can create / update batch photos by using this form</p>
  <form id="uploadimage" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <div class="form-group">  
      ...
      <small id="fileHelp" class="form-text text-muted">This image will be used for Batch  Photo. </small>
