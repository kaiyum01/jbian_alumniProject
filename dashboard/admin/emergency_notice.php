...
var file           = $("#file").val();
  ...
  var update_id           = $("#update_id").val();
   ...
   if(cbo_status==''){ $("#cbo_status_red").css("color","#EE5269" );}else{ $("#cbo_status_red").css("color","green" );}
...
$.ajax({
url: "controller/emergency_notice_controller.php", // Url to which the request is send
...
function show_datas(){
  // $(document).ready(function() {
    ...
    //alert('sdf');
      ...
      type: "GET",
      url: "controller/emergency_notice_controller.php",
    ...
    $.ajax({    //create an ajax request to load_page.php
      ...
      success: function(results){                     
        // alert (results['batch_reward']);
         $('#cbo_status').val(results['status_active']);              
        var img_path=results['emgrNotice_photo_link'];

        var update_pic=results['emgrNotice_photo_link']; 
...
<div class="container-fluid page_path_div" style=" background-color:#fff; height:auto; width:98%;color:#666666;">
  <div class="page_path" style="float:left;">Admin / Emergency Notice</div>
  <div class="pagename" style="float:right;">Page: Emergency Notice</div><hr/>
...
?>
      ...
      <li><a class="menu active" href="emergency_notice.php">Emergency Notice</a></li>
...
?>
      <li><a href="user_create.php">User Create</a></li>
      <li><a class="menu active" href="batch_wise_photo.php">Batch Photos</a></li>
      <li><a href="students_entry_create.php">Students Entry</a></li>
<?php
}
?>     
...
-->
  ...
  <div class="col-md-6">
      <h2>Emergency Notice / update form</h2>
      <p>you can create / update Emergency Notice by using this form</p>
  <form id="uploadimage" action="" method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <div class="form-group">
      ...
      <div class="input-group">  
        <select style="margin-left:8px;" class="form-control" id="cbo_status" name="cbo_status" <?php echo $disabled_cond; ?> >
      <?php
      ...
      ?>
         ...
         <span class="input-group-addon"><span class="glyphicon glyphicon-asterisk" id="cbo_status_red"></span></span>
        </div>
      </div>
    </div> 
    <div class="form-group">  
      <label class="control-label col-sm-4" for="file_pic">Batch Photo:</label>
      <div class="col-sm-8">
       <div class="input-group">
       <input type="file" class="form-control-file" id="file" name="file" aria-describedby="fileHelp">
      <small id="fileHelp" class="form-text text-muted">This image will be used for Emergency Notice/Bill Board. <span style="color: red;">[Image width size must be 1244 to 1920 pixels]</span> </small>
