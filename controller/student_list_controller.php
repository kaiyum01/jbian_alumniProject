		...
		?>
			       <tr>
				     ...
				     <!-- <td><?php //echo date("d-M", strtotime($data['dob'])); ?></td> -->
				      ...
				      <td><a target="_blank" href="<?php echo $data['facebook_id']; ?>"><?php 
				      
				      $facebookID=explode(".com/",$data['facebook_id']); 

				      if($facebookID[1]!=""){ echo "<img style='width:25px; height:auto;' src='assets/images/facebook-logo-png-20.png'"; }else{echo "";}
				      
				      //if($data['facebook_id']==""){ echo ""; }else{ echo "<img style='width:25px; height:auto;' src='assets/images/facebook-logo-png-20.png'";} //echo $data['facebook_id']; ?></a></td>
